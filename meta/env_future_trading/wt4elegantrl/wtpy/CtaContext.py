...
from wtpy.WtDataDefs import WtHftData
...
class CtaContext:
    ...
    def stra_get_bars(
        self, stdCode: str, period: str, count: int, isMain: bool = False
    ) -> WtKlineData:
        """
        获取历史K线
        @stdCode   合约代码
    ...
    def stra_set_position(
        ...
        """
        self.__wrapper__.cta_set_position(
            self.__id__, stdCode, qty, usertag, limitprice, stopprice
        )
    ...
    def stra_exit_long(
        ...
        @stopprice  止价，默认为0
        """
        self.__wrapper__.cta_exit_long(
            self.__id__, stdCode, qty, usertag, limitprice, stopprice
        )

    def stra_enter_short(
        self,
        stdCode: str,
        qty: float,
        usertag: str = "",
        ...
        @stopprice  止价，默认为0
        """
        self.__wrapper__.cta_enter_short(
            self.__id__, stdCode, qty, usertag, limitprice, stopprice
        )
    ...
    def stra_exit_short(
        ...
        @stopprice  止价，默认为0
        """
        self.__wrapper__.cta_exit_short(
            self.__id__, stdCode, qty, usertag, limitprice, stopprice
        )
    ...
    def stra_get_detail_profit(self, stdCode: str, usertag: str, flag: int = 0):
        ...
        @return     盈亏
        """
        return self.__wrapper__.cta_get_detail_profit(
