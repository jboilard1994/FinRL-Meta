...
class WtBtEngine:
    ...
    def set_cta_strategy(
        ...
        """
        ctxid = self.__wrapper__.init_cta_mocker(
            strategy.name(), slippage, hook, persistData
        )
    ...
    def set_sel_strategy(
        self,
        strategy: BaseSelStrategy,
        date: int = 0,
        time: int = 0,
        period: str = "d",
        trdtpl: str = "CHINA",
        ...
        @strategy   策略对象
        """
        ctxid = self.__wrapper__.init_sel_mocker(
            strategy.name(), date, time, period, trdtpl, session, slippage
        )
