...
from wtpy.WtCoreDefs import EVENT_BACKTEST_END
...
class WtBtWrapper:
    ...
    def initialize_cta(
        ...
        try:
            ...
            self.api.init_backtest(
                bytes(logCfg, encoding="utf8"),
                isFile,
                bytes(outDir, encoding="utf8"),
            )
        ...
        self.write_log(
            102,
            "WonderTrader CTA backtest framework initialzied，version：%s" % (self.ver),
        )
    ...
    def initialize_hft(
        ...
        self.write_log(
            102,
            "WonderTrader HFT backtest framework initialzied，version：%s" % (self.ver),
        )
    ...
    def initialize_sel(
        ...
        self.write_log(
            102,
            "WonderTrader SEL backtest framework initialzied，version：%s" % (self.ver),
        )
    ...
    def init_cta_mocker(
        ...
        @return    系统内策略ID
        """
        return self.api.init_cta_mocker(
            bytes(name, encoding="utf8"), slippage, hook, persistData
        )
    ...
    def init_sel_mocker(
        ...
        @return    系统内策略ID
        """
        return self.api.init_sel_mocker(
