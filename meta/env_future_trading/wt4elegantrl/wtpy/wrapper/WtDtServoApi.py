...
class WtDtServoApi:
    ...
    def __init__(self):
        ...
        self.api.get_bars_by_range.argtypes = [
            c_char_p,
            c_char_p,
            c_uint64,
            c_uint64,
        ...
        self.api.get_ticks_by_range.argtypes = [
            c_char_p,
            c_uint64,
            c_uint64,
            CB_GET_TICK,
        ...
        self.api.get_bars_by_count.argtypes = [
            c_char_p,
            c_char_p,
            c_uint32,
            c_uint64,
    ...
    def get_bars(
        ...
        if fromTime is not None:
            ret = self.api.get_bars_by_range(
            ...
            ret = self.api.get_bars_by_count(
                bytes(stdCode, encoding="utf8"),
                bytes(period, "utf8"),
                dataCount,
                endTime,
    ...
    def get_ticks(
        ...
        tick_cache = TickList()
        if fromTime is not None:
            ret = self.api.get_ticks_by_range(
                bytes(stdCode, encoding="utf8"),
                fromTime,
                endTime,
            ...
            ret = self.api.get_ticks_by_count(
                bytes(stdCode, encoding="utf8"),
                dataCount,
                endTime,
                CB_GET_TICK(tick_cache.on_read_tick),
